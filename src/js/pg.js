...
export async function main ( {
  ...
  console.log('Module Worker URL:', moduleWorkerUrl);

  // Construct a full URL for the module worker
  const fullModuleWorkerUrl = new URL(moduleWorkerUrl, base).href;

  console.log('Full Module Worker URL:', fullModuleWorkerUrl);

  const worker = await spawnPHPWorkerThread(fullModuleWorkerUrl, {
    wpVersion: '6.2',
    phpVersion: '8.2',
    storage: '',
